...
import com.milobeene.gamebacklog.auth.domain.AuthToken;
import com.milobeene.gamebacklog.auth.domain.TokenPurpose;
...
class PasswordResetTest extends ControllerTestSupport {
    ...
    public void 재설정하면_남아있던_다른_링크도_죽는다() throws Exception {
        ...
        em.persist(new AuthToken(member, TokenPurpose.PASSWORD_RESET,
                com.milobeene.gamebacklog.auth.service.TokenValuesTestAccess.hash("second-token"),
