...
public interface GameCatalogClient {
     ...
     *
     * @throws com.milobeene.starlog.common.exception.NotFoundException 외부 DB에 없는 id
     * @throws com.milobeene.starlog.common.exception.ExternalApiException 그 외 모든 실패 (FR-SYS-04)
     */
