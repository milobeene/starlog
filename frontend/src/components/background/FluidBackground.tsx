 ...
 */
vec3 colorA = vec3(0.910, 0.592, 0.353);  // #E8975A
vec3 colorB = vec3(0.969, 0.839, 0.627);  // #F7D6A0
vec3 colorC = vec3(0.608, 0.667, 0.722);  // #9BAAB8
vec3 colorD = vec3(0.478, 0.580, 0.282);  // #7A9448
vec3 colorE = vec3(0.118, 0.149, 0.169);  // #1E262B
